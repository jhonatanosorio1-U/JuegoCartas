...
public class Jugador {
    ...
    public void repartir() {
        for (int i = 0; i < TOTAL_CARTAS; i++) {
            ...
            // Mientras esa carta ya haya salido TOTAL_BARAJAS veces, generamos otra
            while (contadorCartas[indice] >= TOTAL_BARAJAS) {
                indice = r.nextInt(52) + 1;
            }

            contadorCartas[indice]++;
            cartas[i] = new Carta(indice);
        }
        //Reiniciamos la cantidad de cartas para cuando se presione el botón repartir nuevamente
        contadorCartas = new int[53];
    }
